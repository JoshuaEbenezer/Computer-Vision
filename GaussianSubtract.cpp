...
int main()
{
	...
	for (int j = 1; j < im1.cols - 1; j++)
	{
		...
		im2.at<Vec3b>(i, j)[0] = im1.at<Vec3b>(i,j)[0]-int(a);
		im2.at<Vec3b>(i, j)[1] = im1.at<Vec3b>(i, j)[1] - int(b);
		im2.at<Vec3b>(i, j)[2] = im1.at<Vec3b>(i, j)[2] - int(c);
